...
public class HashUtil {
	...
	/**
	 * This method is use to compare hotelPartner & server password
	 * 
	 * @param dbPassword           storePassword
	 * @param hotelPartnerPassword hotelPartnerPassword
	 * @return boolean
	 */
	public static boolean passwordVerification(String dbPassword, String hotelPartnerPassword, String dynamicSalt) {
		String securePassword = getSha512(dbPassword + dynamicSalt);
		if (hotelPartnerPassword.equals(securePassword)) {
			return true;
		}
		return false;
	}

	public static String hash(String hash) throws EndlosAPIException {
		BCryptPasswordEncoder bCryptPasswordEncoder = new BCryptPasswordEncoder(11);
		return bCryptPasswordEncoder.encode(hash);
	}

	public static boolean matchHash(String rawHash, String encodedHash) throws EndlosAPIException {
		BCryptPasswordEncoder bCryptPasswordEncoder = new BCryptPasswordEncoder(11);
	 ...
	 */
	public static String generateAuthToken() throws EndlosAPIException {
	 ...
	 * @throws EndlosAPIException
	 */
	public static String generateDeviceToken() throws EndlosAPIException {
		return hash(Utility.generateUuid() + DateUtility.getCurrentEpoch());
	}

	/**
	 * This method is used to generate APi keys shared with multiple hotelPartner.
	 * 
	 * @return
	 * @throws EndlosAPIException
	 */
	public static String generateApiKey(String name) throws EndlosAPIException {
