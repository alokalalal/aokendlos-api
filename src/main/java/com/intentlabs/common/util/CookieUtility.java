...
public class CookieUtility {
	...
	/**
	 * This method is used to set cookies at customer side.
	 * 
	 ...
	 * @return
	 */
	public static void setCookie(HttpServletResponse httpServletResponse, String cookieName, String value,
			Integer maxAge, String path) {
		if (httpServletResponse == null || StringUtils.isBlank(cookieName) || StringUtils.isBlank(value)) {
			return;
		}
